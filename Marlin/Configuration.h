...
#define STRING_CONFIG_H_AUTHOR "(Cagdas, Ender3v2)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 8.5, -31.6, 3.90 }
